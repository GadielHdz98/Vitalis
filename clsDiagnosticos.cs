    ...
    internal class clsDiagnosticos
    {
        ...
        public DataTable Consultar()
        {
            ...
            try
            {
                ...
                using (var conexion = conexionBD.AbrirConexion())
                {
                    string sql = @"SELECT id_Diagnostico AS Clave, nombreDiagnostico AS Diagnostico, Sintomas FROM Sintomas WHERE nombreDiagnostico LIKE @nombre;";
                ...
                using (var conexion = conexionBD.AbrirConexion())
                {
                    switch (tipoOperacion)
                    {
                        ...
                        case 1: //Actualizar registro
                            ...
                            string sqlA = "UPDATE Diagnosticos D SET D.nombreDiagnostico = @Nombre, D.Sintomas = @Sintomas WHERE D.id_Diagnostico = @idDiagnostico";
